const ko = {
  ...
  home: {
    ...
    programs: {
      ...
      body: "처음 등록 시 배치 진단으로 실력을 파악한 뒤, 학년과 무관하게 학생 개인의 실력에 맞춘 학습지와 문제집으로 진행합니다(무학년제). 매 수업은 지난 시간 오답·약점 복습 및 수학 올림피아드 문제 풀이(20분) → 수준에 맞는 정규 문제집(40분) → 수학 교구·보드게임 또는 보충(10분) 순으로 70분간 진행됩니다.",
