const ko = {
  ...
  home: {
    ...
    programs: {
      ...
      h3ko: "학년이 아닌, 실력으로 배정합니다",
      body: "처음 등록 시 배치 진단으로 실력을 파악한 뒤, 학년과 무관하게 수준별로 반을 구성합니다(무학년제). 매 수업은 지난 시간 오답·약점 복습(10분) → 수준에 맞는 정규 문제집(45분) → 수학 교구·보드게임 또는 보충(15분) 순으로 70분간 진행됩니다.",
      classSize: { label: "정원", value: "회당 최대 4명", sublabel: "" },
      time: { label: "시간", value: "주 1~4회 · 70분", sublabel: "" },
      schedule: "월·화·목·금 오후 시간대 · 70분 수업 (오후 5시 - 6시10분, 오후 6시30분 - 7시40분)",
    ...
    how: {
      ...
      steps: [
        { title: "Placement", titleKo: "배치 진단", desc: "처음 등록 시 한 번만 진행합니다. 학년과 무관하게 실력 수준을 파악해 맞는 반에 배정합니다(무학년제)." },
        { title: "Mistake Review", titleKo: "오답 복습 (10분)", desc: "지난 수업에서 자주 틀리거나 어려워했던 문제를 기록해두고, 이번 수업 처음 10분 동안 비슷한 문제로 다시 확인합니다." },
        { title: "Leveled Practice", titleKo: "수준별 문제풀이 (45분)", desc: "학년이 아닌 개인 실력에 맞춘 정규 문제집으로 45분간 개념을 다집니다." },
        { title: "Hands-on Learning", titleKo: "교구·보드게임 (15분)", desc: "나머지 15분은 수학 교구와 보드게임, 또는 보충 학습으로 개념을 쉽고 재미있게 체화합니다." },
        { title: "Progress Tracking", titleKo: "학습 관리", desc: "새 내용을 가르치는 것 이상으로, 학생이 무엇을 자주 틀리는지 꾸준히 기록하고 관리하는 데 중점을 둡니다." },
        { title: "Parent Update", titleKo: "학부모 소통", desc: "매월 한 번, 수업 내용·진도·오답 관리 현황을 학부모와 정기적으로 공유합니다." },
      ],
    },
    curriculum: {
      eyebrow: "커리큘럼",
  ...
  programs: {
    meta: {
      title: "프로그램",
      description: "무학년 소수 정예 수업. 3-6학년 학생이 학년이 아닌 실력 수준으로 배정되어 같은 교재와 커리큘럼으로 학습합니다.",
    },
    header: {
      eyebrow: "프로그램",
      title: "무학년 소수 정예, 검증된 커리큘럼",
      titleKo: "",
      desc: "학년이 아닌 실력 수준으로 배정되는 소수 정예 수업입니다. 모든 학생이 같은 교재와 자료를 사용하되, 개인 수준에 맞춰 진행합니다.",
    },
    pillars: [
      {
