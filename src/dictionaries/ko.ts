const ko = {
  ...
  home: {
    ...
    programs: {
      ...
      titleKo: "",
      desc: "Singapore Math와 Beast Academy로 영재 수학과 토론 수업, IXL Math로 개념 완성, CogAT/NNAT 준비까지 모두 4명 소수 정예 수업으로 체계적으로 운영됩니다.",
      h3en: "Same room. Proven curriculum.",
      h3ko: "검증된 교재, 함께 성장하는 수업",
      body: "학년별 4명이 Singapore Math와 Beast Academy로 영재 수학과 토론 중심 수업을 하고, IXL Math로 개념을 완성하며, CogAT/NNAT 준비까지 한 수업 안에서 이루어집니다.",
    ...
    how: {
      ...
      steps: [
        ...
        { title: "IXL Diagnostic", titleKo: "숙제 점검", desc: "매 수업 시작, IXL Math 숙제를 검사·채점합니다. 정답률 데이터로 약점을 파악하고 그날 수업 방향을 설정합니다." },
        { title: "Concept Learning", titleKo: "개념 학습", desc: "Singapore Math와 Beast Academy 학습지로 수학 개념의 '왜(Why)'를 탐구합니다. 답이 아닌 사고 과정을 중심으로 배웁니다." },
