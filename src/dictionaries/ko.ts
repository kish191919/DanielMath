const ko = {
  ...
  home: {
    hero: {
      ...
      h1highlight: "관리형",
      h1line2: "무학년 수학 아카데미.",
      subtitle: "4명 정원, 학년 구분 없이 개인 실력에 맞춘 학습지로 진행됩니다.",
      desc: "배치 진단부터 오답 관리까지, 한 수업에",
      ctaInquire: "상담 신청",
      ctaPrograms: "프로그램 보기",
    },
    stats: [
      { value: "무학년제", label: "학년 구분 없음", sublabel: "실력별 맞춤 학습지" },
    ...
    programs: {
      eyebrow: "프로그램",
      title: "소수 정예, 학년이 아닌 개인 실력별 맞춤 학습",
      titleKo: "",
      desc: "학년과 무관하게 학생 개인의 실력에 맞춘 학습지로 진행하고, 오답을 기록해 다시 확인합니다.",
      h3en: "Not grade-based. Individually leveled.",
      h3ko: "학년이 아닌, 실력에 맞춥니다",
      body: "처음 등록 시 배치 진단으로 실력을 파악한 뒤, 학년과 무관하게 학생 개인의 실력에 맞춘 학습지와 문제집으로 진행합니다(무학년제). 매 수업은 지난 시간 오답·약점 복습(10분) → 수준에 맞는 정규 문제집(45분) → 수학 교구·보드게임 또는 보충(15분) 순으로 70분간 진행됩니다.",
      classSize: { label: "정원", value: "회당 최대 4명", sublabel: "" },
      time: { label: "시간", value: "주 1~4회 · 70분", sublabel: "" },
      schedule: "월·화·목·금 오후 · 70분 수업",
    ...
    how: {
      ...
      titleKo: "",
      desc: "매 수업은 오답 복습(10분) → 수준별 문제풀이(45분) → 교구·보드게임(15분) 순으로 진행됩니다.",
      steps: [
        { title: "Mistake Review", titleKo: "오답 복습 (10분)", desc: "지난 오답을 비슷한 문제로 재확인" },
        { title: "Leveled Practice", titleKo: "수준별 문제풀이 (45분)", desc: "실력에 맞춘 정규 문제집으로 개념 완성" },
        { title: "Hands-on Learning", titleKo: "교구·보드게임 (15분)", desc: "교구·보드게임으로 재미있게 체화" },
      ],
    },
    curriculum: {
      eyebrow: "커리큘럼",
    ...
    cta: {
      ...
      highlightKo: "상담 신청",
      desc: "등록 가능 인원이 제한적입니다. 자녀의 현재 수준을 알려주시면 꼭 맞는 학습 계획으로 안내해드립니다.",
      ctaInquire: "상담 신청",
      ctaPrograms: "프로그램 보기",
    },
  },
  ...
  programs: {
    meta: {
      title: "프로그램",
      description: "무학년 소수 정예 수업. 3-6학년 학생이 학년과 무관하게 실력 수준에 맞춘 교재와 학습지로 진행합니다.",
    },
    header: {
      eyebrow: "프로그램",
      title: "무학년 소수 정예, 검증된 커리큘럼",
      titleKo: "",
      desc: "학년과 무관하게 개인 실력에 맞춰 진행되는 소수 정예 수업입니다. 학생마다 수준에 맞는 교재와 학습지를 사용합니다.",
    },
    pillars: [
      {
        title: "Personalized by Level",
        titleKo: "학생별 맞춤 교재",
        desc: "학년이 아닌 실력에 맞춰 학생마다 교재와 학습지가 다르게 배정됩니다.",
      },
      {
        title: "Three-Step Curriculum",
        titleKo: "3단계 학습 흐름",
        desc: "IXL Math로 개념을 익히고, Singapore Math로 깊이 이해하고, Beast Academy(AoPS)로 다양한 문제 유형을 접합니다.",
      },
      {
    ...
    coverage: {
      eyebrow: "커리큘럼",
      title: "검증된 세 교재, 하나의 학습 흐름",
      titleKo: "",
      desc: "IXL Math로 개념을 익히고, Singapore Math로 깊이 이해하고, Beast Academy(AoPS)로 다양한 문제 유형을 접하는 3단계로 진행됩니다.",
      chips: [
        { label: "IXL Math", sublabel: "개념 습득" },
        { label: "Singapore Math", sublabel: "깊은 이해" },
        { label: "Beast Academy", sublabel: "다양한 문제 유형" },
      ],
      optional: {
        label: "CogAT / NNAT",
        sublabel: "선택 보충",
        desc: "정규 수업 시간에는 다루지 않으며, 필요한 학생에게만 별도로 제공됩니다.",
      },
    },
    ops: {
      eyebrow: "운영 안내",
      ...
      items: [
        ...
        { label: "운영시간", value: "오후 5시 – 7시 40분", sublabel: "" },
        { label: "정원", value: "클래스당 최대 4명", sublabel: "" },
      ],
      noteHeader: "요일·교시 자유 선택 · 70분 수업",
      scheduleRows: [
        "1교시  ·  오후 5:00–6:10",
        "2교시  ·  오후 6:30–7:40",
      ],
  ...
  blog: {
    ...
    eyebrow: "블로그",
    title: "수학 교육 이야기",
    desc: "Fairfax 학부모가 꼭 알아야 할 AAP, 시험 준비, 교재, 경시대회 정보를 쉽게 풀어드립니다.",
    backToList: "블로그 목록으로",
    readMore: "자세히 읽기",
    minRead: "분",
    publishedAt: "작성일",
