const ko = {
  ...
  home: {
    ...
    hero: {
      ...
      h1line1: "Fairfax 3–6학년을 위한",
      h1highlight: "4명 소수정예",
      h1line2: "맞춤형 수학 아카데미.",
      subtitle: "진단 → 수준별 학습 → 오답 추적 → 사고력 확장",
      desc: "배치 진단으로 파악한 실력에 맞춘 학습지와 문제집으로 70분 수업을 진행합니다.",
      ctaInquire: "상담 신청",
      ctaPrograms: "프로그램 보기",
    },
    stats: [
      { value: "3-6학년", label: "대상 학년", sublabel: "초등 중·고학년" },
      { value: "4명", label: "클래스당 정원", sublabel: "소수정예" },
      { value: "주 1~4회", label: "요일·횟수 자유 선택", sublabel: "월·화·목·금 중" },
      { value: "70분", label: "수업 시간", sublabel: "1회 기준" },
    ],
    programs: {
      eyebrow: "프로그램",
      title: "3-6학년, 개인 실력에 맞춘 소수정예 학습",
      titleKo: "",
  ...
  programs: {
    ...
    header: {
      eyebrow: "프로그램",
      title: "3-6학년을 위한 소수 정예, 검증된 커리큘럼",
      titleKo: "",
      desc: "개인 실력에 맞춰 진행되는 4명 소수 정예 수업입니다. 학생마다 수준에 맞는 교재와 학습지를 사용합니다.",
    },
    pillars: [
      {
        title: "Personalized by Level",
        titleKo: "학생별 맞춤 교재",
        desc: "학생 개인의 실력에 맞춰 학생마다 교재와 학습지가 다르게 배정됩니다.",
      },
      {
