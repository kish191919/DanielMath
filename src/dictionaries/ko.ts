const ko = {
  ...
  programs: {
    meta: {
      title: "프로그램",
      description: "무학년 소수 정예 수업. 3-6학년 학생이 학년과 무관하게 실력 수준에 맞춘 학습지로 같은 교재와 커리큘럼을 학습합니다.",
    },
    header: {
      eyebrow: "프로그램",
      title: "무학년 소수 정예, 검증된 커리큘럼",
      titleKo: "",
      desc: "학년과 무관하게 개인 실력에 맞춰 진행되는 소수 정예 수업입니다. 모든 학생이 같은 교재와 자료를 사용하되, 학습지와 진도는 개인 수준에 맞춥니다.",
    },
    pillars: [
      {
