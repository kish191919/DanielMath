...
const en: Dictionary = {
  ...
  home: {
    ...
    programs: {
      ...
      h3ko: "",
      body: "A one-time placement diagnostic determines each student's ability level, regardless of school grade. Every 70-minute session runs at each student's own pace with materials matched to their level: mistake review from last time (10 min) → leveled practice with regular workbooks (45 min) → math manipulatives, board games, or reinforcement (15 min).",
    ...
    how: {
      ...
      steps: [
        { title: "Mistake Review", titleKo: "", desc: "Revisit last session's mistakes" },
