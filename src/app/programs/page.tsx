...
export const metadata: Metadata = {
  title: "Program · 프로그램",
  description:
    "K-6 모든 학생이 같은 공간에서 학습하지만, 학년·실력에 맞춘 맞춤형 학습지와 숙제가 매 수업 새롭게 제공됩니다.",
};
      ...
      <Section>
        <Container>
          <SectionHeader
            ...
            description="K-6 학생이 같은 공간에서 모이지만, 학년과 실력에 맞춰 학생마다 다른 학습지와 숙제가 매 수업 새롭게 제공됩니다. 학년 그룹으로 나누지 않고, 각 학생의 진도로 학습합니다."
          />
