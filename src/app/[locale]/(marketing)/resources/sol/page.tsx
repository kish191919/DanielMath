...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return locale === "ko"
    ? { title: "Virginia SOL 수학 기준", description: "버지니아 주 수학 성취 기준(SOL)을 유치원~6학년별로 한국어로 설명합니다." }
    : { title: "Virginia SOL Math Standards", description: "Virginia Standards of Learning for math — explained grade by grade from kindergarten through 6th grade." };
}
