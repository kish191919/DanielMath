...
export const schoolCalendars: SchoolYearCalendar[] = [
  {
    ...
    events: [
      ...
      { dateStart: "2027-04-19", labelEn: "No School – Teacher Workday", labelKo: "휴교 (교사 업무일)", type: "noSchool" },
  ...
  },
  {
    ...
    events: [
      ...
      { dateStart: "2027-10-11", labelEn: "Indigenous Peoples' Day", labelKo: "원주민의 날", type: "holiday" },
      { dateStart: "2027-10-28", labelEn: "End of Q1 (2-hr Early Release)", labelKo: "1분기 마감", type: "quarter" },
      { dateStart: "2027-11-02", labelEn: "No School – Election Day", labelKo: "휴교 (선거일)", type: "noSchool" },
      ...
      { dateStart: "2028-01-20", labelEn: "End of Q2 (2-hr Early Release)", labelKo: "2분기 마감", type: "quarter" },
      { dateStart: "2028-02-21", labelEn: "Presidents' Day", labelKo: "대통령의 날", type: "holiday" },
      { dateStart: "2028-03-30", labelEn: "End of Q3 (2-hr Early Release)", labelKo: "3분기 마감", type: "quarter" },
  ...
  },
  {
    id: "2028-29",
    events: [
      { dateStart: "2028-08-21", labelEn: "First Day of School", labelKo: "개학일", type: "important" },
      { dateStart: "2028-09-01", dateEnd: "2028-09-04", labelEn: "Labor Day Break", labelKo: "노동절 연휴", type: "break" },
      { dateStart: "2028-10-09", labelEn: "Indigenous Peoples' Day", labelKo: "원주민의 날", type: "holiday" },
      { dateStart: "2028-11-03", labelEn: "End of Q1 (2-hr Early Release)", labelKo: "1분기 마감", type: "quarter" },
      { dateStart: "2028-11-07", labelEn: "No School – Election Day", labelKo: "휴교 (선거일)", type: "noSchool" },
      { dateStart: "2028-11-11", labelEn: "Veterans Day", labelKo: "재향군인의 날", type: "holiday" },
      { dateStart: "2028-11-22", dateEnd: "2028-11-24", labelEn: "Thanksgiving Break", labelKo: "추수감사절 연휴", type: "break" },
      { dateStart: "2028-12-18", dateEnd: "2029-01-01", labelEn: "Winter Break", labelKo: "겨울 방학", type: "break" },
      { dateStart: "2029-01-15", labelEn: "Martin Luther King Jr. Day", labelKo: "MLK 기념일", type: "holiday" },
      { dateStart: "2029-01-25", labelEn: "End of Q2 (2-hr Early Release)", labelKo: "2분기 마감", type: "quarter" },
      { dateStart: "2029-02-19", labelEn: "Presidents' Day", labelKo: "대통령의 날", type: "holiday" },
      { dateStart: "2029-03-26", dateEnd: "2029-03-30", labelEn: "Spring Break", labelKo: "봄 방학", type: "break" },
      { dateStart: "2029-04-12", labelEn: "End of Q3 (2-hr Early Release)", labelKo: "3분기 마감", type: "quarter" },
      { dateStart: "2029-05-28", labelEn: "Memorial Day", labelKo: "현충일", type: "holiday" },
      { dateStart: "2029-06-15", labelEn: "Last Day of School (Early Release)", labelKo: "종업일", type: "important" },
    ],
  },
];
